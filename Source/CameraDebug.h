/*
  ==============================================================================
    ...
    ÆÁÄ»ÊµÊ±ÏÔÊ¾ Camera ²ÎÊýµÄµ÷ÊÔÃæ°å£¬Ö§³Ö F3 ÇÐ»»ÏÔÊ¾/Òþ²Ø
    ¡ï ÔÚ OpenGL ÖÐ»æÖÆ£¨²»ÊÇ Component£©
  ==============================================================================
*/
#pragma once
...
namespace sc
{
    ...
    public:
        ...
        /** ÔÚ renderOpenGL ÖÐµ÷ÓÃ´Ë·½·¨£¬Ê¹ÓÃ JUCE Graphics ÔÚÆÁÄ»ÉÏ·½»æÖÆ */
        // CameraDebug.h ¶¥²¿ÐÂÔö
#include <cstdio>

// Ìæ»»Ô­À´µÄ std::ostringstream Ð´·¨
